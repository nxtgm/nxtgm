...
//********************************************************//
double HungarianAlgorithm::Solve(const xt::xtensor<double, 2> &DistMatrix, std::vector<int> &Assignment)
{
    unsigned int nRows = DistMatrix.shape()[0];
    unsigned int nCols = DistMatrix.shape()[1];

...
class HigherOrderEnergy
{
  ...
  private:
    ...
    static int Compare(int d1, const VarId vars1[], int d2, const VarId vars2[]);
...
template <typename R, int D>
inline typename HigherOrderEnergy<R, D>::VarId HigherOrderEnergy<R, D>::AddVar()
{
...
template <typename R, int D>
inline typename HigherOrderEnergy<R, D>::VarId HigherOrderEnergy<R, D>::AddVars(int n)
{

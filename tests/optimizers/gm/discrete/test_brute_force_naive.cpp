...
TEST_CASE("brute-force-naive")
{
    ...
    SUBCASE("basics")
    {
        nxtgm::tests::test_discrete_gm_optimizer<nxtgm::BruteForceNaive>(
            std::string("brute-force-naive"), {nxtgm::BruteForceNaive::parameters_type{}},
    ...
    SUBCASE("time-limited")
    {
        nxtgm::tests::test_discrete_gm_optimizer<nxtgm::BruteForceNaive>(
            ...
            {nxtgm::BruteForceNaive::parameters_type{std::chrono::duration<double>(std::chrono::milliseconds(50))}

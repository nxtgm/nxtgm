...
TEST_CASE("icm")
{
    ...
    nxtgm::tests::test_discrete_gm_optimizer<nxtgm::Icm>(
        ...
        std::make_tuple(nxtgm::tests::PottsChain{10, 2}, nxtgm::tests::PottsChain{8, 3}, nxtgm::tests::Star{10, 3},
                        ...
                        nxtgm::tests::UniqueLabelChain{4, 5}, nxtgm::tests::UniqueLabelChain{5, 5},
                        nxtgm::tests::UniqueLabelChain{10, 10}, nxtgm::tests::InfeasibleModel{10, 2}),
        100,
        std::make_tuple(nxtgm::tests::CheckOptimizationStatus{nxtgm::OptimizationStatus::LOCAL_OPTIMAL},

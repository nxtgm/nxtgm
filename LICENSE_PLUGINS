...
* The qpbo-kolmogorov plugin is licensed under the GNU General Public License v3.0.
    ...
    See  [GPL.TXT](src/nxtgm/plugins/qpbo/kolmogorov/QPBO/GPL.TXT) for the full license text.

* The min_st_cut-komogorov plugin is licensed under the GNU General Public License v3.0.
    See `src/nxtgm/plugins/min_st_cut/kolmogorov/maxflow-v3.04/GPL.TXT` for the full license text.

* The hocr-fix plugin is licensed under the MIT License.
    See `src/nxtgm/plugins/hocr_fix/LICENSE` for the full license text.

...
inline RandomAccessSet<Key, Compare, Alloc>::RandomAccessSet(const size_t reserveSize, const Compare &compare,
                                                             const Alloc &alloc)
    : vector_(alloc),
      compare_(compare)
{
...
template <class Key, class Compare, class Alloc>
inline const typename RandomAccessSet<Key, Compare, Alloc>::value_type &RandomAccessSet<
    Key, Compare, Alloc>::operator[](const typename RandomAccessSet<Key, Compare, Alloc>::size_type index) const
{
...
/// \allloc allocator
template <class Key, class Compare, class Alloc>
inline RandomAccessSet<Key, Compare, Alloc>::RandomAccessSet(const Compare &compare, const Alloc &alloc)
    : vector_(alloc),
      compare_(compare)
{
}
...
template <class Key, class Compare, class Alloc>
template <class InputIterator>
inline RandomAccessSet<Key, Compare, Alloc>::RandomAccessSet(InputIterator beginInput, InputIterator endInput,
...
template <class Key, class Compare, class Alloc>
inline RandomAccessSet<Key, Compare, Alloc>::RandomAccessSet(const RandomAccessSet<Key, Compare, Alloc> &src)
    : vector_(src.vector_),
...
/// \param src other random access set
template <class Key, class Compare, class Alloc>
inline RandomAccessSet<Key, Compare, Alloc> &RandomAccessSet<Key, Compare, Alloc>::operator=(
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::begin() const
{
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::end() const
{
    return vector_.end();
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::rbegin()
    const
{
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::rend() const
{
    return vector_.rend();
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::iterator RandomAccessSet<Key, Compare, Alloc>::begin()
{
    return vector_.begin();
}
...
/// \param end iterator
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::iterator RandomAccessSet<Key, Compare, Alloc>::end()
{
    return vector_.end();
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::iterator RandomAccessSet<Key, Compare, Alloc>::rbegin()
{
    return vector_.rbegin();
}
...
/// \param reverse end iterator
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::iterator RandomAccessSet<Key, Compare, Alloc>::rend()
{
    return vector_.rend();
}
...
template <class Key, class Compare, class Alloc>
inline bool RandomAccessSet<Key, Compare, Alloc>::empty() const
{
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::size_type RandomAccessSet<Key, Compare, Alloc>::size() const
{
    return vector_.size();
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::size_type RandomAccessSet<Key, Compare, Alloc>::max_size() const
{
...
/// set
template <class Key, class Compare, class Alloc>
inline std::pair<typename RandomAccessSet<Key, Compare, Alloc>::const_iterator, bool> RandomAccessSet<
    Key, Compare, Alloc>::insert(const typename RandomAccessSet<Key, Compare, Alloc>::value_type &value)
{
    bool found(true);
...
template <class Key, class Compare, class Alloc>
template <class InputIterator>
inline void RandomAccessSet<Key, Compare, Alloc>::insert(InputIterator first, InputIterator last)
{
    while (first != last)
    {
        this->insert(*first);
...
/// \param value element to insert
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::insert(
...
/// \param position iterator to the position
template <class Key, class Compare, class Alloc>
inline void RandomAccessSet<Key, Compare, Alloc>::erase(
...
/// \param x element
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::size_type RandomAccessSet<Key, Compare, Alloc>::erase(
...
template <class Key, class Compare, class Alloc>
inline void RandomAccessSet<Key, Compare, Alloc>::swap(RandomAccessSet<Key, Compare, Alloc> &rhs)
{
...
/// erases all elements
template <class Key, class Compare, class Alloc>
inline void RandomAccessSet<Key, Compare, Alloc>::clear()
{
    vector_.clear();
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::key_compare RandomAccessSet<Key, Compare, Alloc>::key_comp() const
{
    return compare_;
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::value_compare RandomAccessSet<Key, Compare, Alloc>::value_comp()
    const
{
    return compare_;
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::find(
...
/// iterator if the element was not found
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::iterator RandomAccessSet<Key, Compare, Alloc>::find(
...
/// \return zero or one
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::size_type RandomAccessSet<Key, Compare, Alloc>::count(
    const typename RandomAccessSet<Key, Compare, Alloc>::key_type &value) const
{
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::lower_bound(
    const typename RandomAccessSet<Key, Compare, Alloc>::key_type &value) const
{
...
/// \return iterator to lower bound
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::iterator RandomAccessSet<Key, Compare, Alloc>::lower_bound(
    const typename RandomAccessSet<Key, Compare, Alloc>::key_type &value)
{
    return std::lower_bound(vector_.begin(), vector_.end(), value, compare_);
}
...
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::const_iterator RandomAccessSet<Key, Compare, Alloc>::upper_bound(
    const typename RandomAccessSet<Key, Compare, Alloc>::key_type &value) const
{
...
/// \return iterator to upper bound
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::iterator RandomAccessSet<Key, Compare, Alloc>::upper_bound(
    const typename RandomAccessSet<Key, Compare, Alloc>::key_type &value)
{
    return std::upper_bound(vector_.begin(), vector_.end(), value, compare_);
}
...
template <class Key, class Compare, class Alloc>
inline std::pair<typename RandomAccessSet<Key, Compare, Alloc>::const_iterator,
...
/// \return iterator pair to lower equal range
template <class Key, class Compare, class Alloc>
inline std::pair<typename RandomAccessSet<Key, Compare, Alloc>::iterator,
                 typename RandomAccessSet<Key, Compare, Alloc>::iterator>
RandomAccessSet<Key, Compare, Alloc>::equal_range(const typename RandomAccessSet<Key, Compare, Alloc>::key_type &value)
{
    return std::equal_range(vector_.begin(), vector_.end(), value, compare_);
}
/// allocators
/// \return allocator
template <class Key, class Compare, class Alloc>
inline typename RandomAccessSet<Key, Compare, Alloc>::allocator_type RandomAccessSet<Key, Compare,

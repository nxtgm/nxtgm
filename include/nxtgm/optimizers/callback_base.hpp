...
namespace nxtgm {
template <class OPTIMIZER_BASE_TYPE> class CallbackBase {
public:
...
template <class REPORTER_CALLBACK_BASE_TYPE> class ReporterCallbackWrapper {
public:
  ...
  // convert to bool
  inline operator bool() const { return this->reporter_callback_ != nullptr; }
...
template <class REPAIR_CALLBACK_BASE_TYPE> class RepairCallbackWrapper {
public:
  using repair_callback_base_type = REPAIR_CALLBACK_BASE_TYPE;
  using optimizer_base_type =
      typename repair_callback_base_type::optimizer_base_type;
  ...
  // convert to bool
  inline operator bool() const { return this->repair_callback_ != nullptr; }
